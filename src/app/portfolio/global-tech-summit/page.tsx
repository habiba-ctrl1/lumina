    ...
    <main className="min-h-screen bg-white overflow-hidden pt-20">
      ...
      <section className="py-32 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-gray-600 font-light text-base leading-relaxed space-y-24">
        ...
        <div className="bg-gray-50 border border-gray-100 p-12 md:p-24 rounded-[4rem] flex flex-col items-center text-center">
          ...
          <h2 className="text-2xl md:text-3xl font-sans font-bold text-black mb-8 uppercase tracking-tight">Operational <span className="text-primary italic">Perfection</span></h2>
          ...
          <div className="flex gap-12">
            <div>
              ...
              <div className="text-[10px] text-gray-400 uppercase tracking-widest font-bold">Live Viewers</div>
            </div>
            <div className="w-px h-10 bg-gray-200" />
            <div>
              <div className="text-2xl font-bold text-black">500+</div>
              <div className="text-[10px] text-gray-400 uppercase tracking-widest font-bold">Startups Present</div>
            </div>
          </div>
        </div>
      </section>
