...
const pseoCities: Record<string, CityData> = {
  neom: {
    ...
    knowsAbout: [
      ...
      "NEOM event permits and access coordination",
    ...
    geoCitation: [
      { title: "NEOM Access Coordination", body: "We help clients navigate NEOM's event permit and access requirements — the gateway to producing private events at Sindalah, Aqaba Mountain, and NEOM Bay." },
  ...
  madinah: {
    ...
    knowsAbout: [
      ...
      "Islamic finance and knowledge-economy conference management",
