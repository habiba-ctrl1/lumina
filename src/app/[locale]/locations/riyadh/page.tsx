...
export default function RiyadhPage() {
  return (
    <main className="min-h-screen bg-ink-950 overflow-hidden pt-20">
      ...
      <section className="relative h-[80vh] flex items-center justify-center">
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
          ...
          <p className="text-sand-200 text-sm md:text-base mb-8 max-w-2xl mx-auto leading-relaxed">
            From the soaring heights of the <span className="text-sand-50 font-semibold">Kingdom Centre</span> to the majestic heritage of <span className="text-sand-50 font-semibold">Diriyah</span>, we curate experiences that define the Riyadh skyline.
          </p>
      ...
      <section className="py-32 relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-24">
          <div>
            ...
            <h2 className="font-display font-medium text-sand-50 mb-8 text-2xl md:text-3xl font-bold">Where Heritage Meets <span className="text-shimmer italic">Modernity</span></h2>
      ...
      <section className="py-32 bg-ink-900/50 border-t border-b border-ink-600/50 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="font-display font-medium text-sand-50 mb-8 text-2xl md:text-3xl font-bold">Signature Riyadh <span className="text-shimmer italic">Services</span></h2>
            <p className="text-sand-200 max-w-2xl mx-auto text-sm">Customized event solutions for the capital&apos;s most discerning clientele.</p>
          </div>
      ...
      <section className="py-32 relative overflow-hidden bg-ink-950">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row gap-16 items-center">
            <div className="lg:w-1/2">
              <span className="section-label">Riyadh Leadership</span>
              <h2 className="font-display font-medium text-sand-50 mb-8 text-2xl md:text-3xl font-bold">The Minds Behind <span className="text-shimmer italic">The Magic</span></h2>
              <p className="text-sand-200 text-sm leading-relaxed mb-8">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-10">
                {[
                  ...
                  <div key={i} className="flex gap-10 p-5 bg-ink-800 border border-ink-500 rounded-sm shadow-2xs">
                    <div className="w-12 h-12 bg-ink-950 border border-ink-600 rounded-full flex items-center justify-center text-emerald-800 shrink-0">
                      <User size={20} />
                    </div>
                    <div>
                      <h3 className="text-sand-50 font-medium mb-1 font-display">{member.name}</h3>
                      <p className="text-gold-400 text-[10px] uppercase tracking-wider mb-2 font-semibold">{member.role}</p>
                      <p className="text-sand-300 text-xs font-light">{member.desc}</p>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <div className="lg:w-1/2 grid grid-cols-2 gap-10">
              <div className="space-y-4">
                <div className="h-64 relative rounded-sm overflow-hidden border border-ink-600 shadow-sm">
                  <Image src="/gallery_wedding_reception.webp" alt="Team at work" width={600} height={400} className="w-full h-full object-cover" />
                </div>
                <div className="h-48 relative rounded-sm overflow-hidden border border-ink-600 shadow-sm">
      ...
      <section className="py-32 border-t border-ink-600/20 bg-ink-900/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="font-display font-medium text-sand-50 mb-8 text-2xl md:text-3xl font-bold">Strategic Venue <span className="text-shimmer italic">Partnerships</span></h2>
            <p className="text-sand-200 max-w-2xl mx-auto text-sm">Exclusive access to Riyadh&apos;s most coveted and prestigious locations.</p>
          </div>
