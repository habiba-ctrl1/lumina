  ...
  return {
    ...
    openGraph: {
      ...
      description: isAr
        ...
        : "End-to-end corporate event planning for AGMs, executive summits, gala dinners, and Vision 2030 activations across Riyadh, Jeddah, and Dammam. Full-service PCO with permit and compliance support through trusted partners.",
      url: canonical,
      type: "website",
      images: [
        {
