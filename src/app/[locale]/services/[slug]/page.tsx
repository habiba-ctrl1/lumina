...
> = {
  ...
  "corporate-events-riyadh": {
    ...
    heroImage: "/riyadh_summit_people.webp",
  ...
  "corporate-events-jeddah": {
    ...
    heroImage: "/jeddah_luxury_people.webp",
  ...
  "corporate-events-dammam": {
    ...
    heroImage: "/alkhobar_corporate_people.webp",
  ...
  "luxury-weddings-riyadh": {
    ...
    heroImage: "/wedding_hall_grand_entrance.webp",
  ...
  "luxury-weddings-jeddah": {
    ...
    heroImage: "/jeddah_beach_wedding_setup.webp",
  ...
  "luxury-weddings-dammam": {
    ...
    heroImage: "/luxury_wedding_couple_guests.webp",
  ...
  "event-production-alula": {
    ...
    heroImage: "/alula_gala_people.webp",
  ...
  "cultural-events-riyadh": {
    ...
    heroImage: "/majlis_gathering_people.webp",
  ...
  "destination-events-neom": {
    ...
    heroImage: "/neom_summit_people.webp",
      ...
      <main className="min-h-screen bg-white text-slate-800">
        ...
        <section className="py-20 bg-white border-t border-slate-200">
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            <h3 className="text-lg font-bold text-slate-900 mb-8 uppercase tracking-widest">
              Related Services
            </h3>
