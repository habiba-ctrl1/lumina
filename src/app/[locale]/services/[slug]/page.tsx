...
> = {
  ...
  "corporate-events-jeddah": {
    ...
    faqs: [
      { q: "What are the best corporate event venues in Jeddah?", a: "Top venues in Jeddah include the Rosewood Jeddah, Ritz-Carlton Jeddah, Waldorf Astoria (Qasr Al Sharq), InterContinental Jeddah, and the Jeddah Center for Forums and Events. We have strong working relationships across these venues." },
  ...
  "corporate-events-dammam": {
    ...
    bulletPoints: [
      ...
      "Energy-sector aligned event management",
      "Cross-regional logistics (Dammam–Khobar–Dhahran corridor)",
    ],
    faqs: [
      { q: "What corporate event venues exist in Dammam?", a: "Dammam's top corporate event venues include the Intercontinental Hotel Al Khobar, Four Points by Sheraton Dammam, Marriott Hotel Dammam, and the Dammam Chamber of Commerce. Saudi Event Management has strong working relationships across these venues." },
      { q: "Do you manage corporate events for the energy sector in Dammam?", a: "Yes. Saudi Event Management coordinates corporate events aligned with energy-sector operational standards, including executive summits, training conferences, and corporate celebration events in the Eastern Province." },
  ...
  "exhibitions-dammam": {
    ...
    bulletPoints: [
      ...
      "Energy-sector aligned exhibition services",
    ...
    faqs: [
      ...
      { q: "Do you manage oil and gas trade shows in Saudi Arabia?", a: "Yes. Saudi Event Management coordinates oil and gas sector exhibitions, including AlShargiyah expos, connecting global industry players with the regional energy supply chain ecosystem." },
  ...
  "conference-management-dammam": {
    ...
    details: "Our Dammam conference team manages everything from multi-day technical symposiums aligned with energy-sector operational requirements to regional chamber of commerce summits — delivering seamless execution with full technical support.",
    bulletPoints: [
  ...
  "event-production-alula": {
    ...
    details: "From immersive light shows illuminating ancient Nabataean sandstone at Hegra to custom concert stages built at Maraya, our production team masters the extraordinary demands of desert heritage environments with full heritage-site compliance.",
    bulletPoints: [
      ...
      "Zero-impact production with full heritage-site compliance",
      "Climate-controlled technical environments",
    ],
    faqs: [
      { q: "Can you do projection mapping at AlUla heritage sites?", a: "Yes. Saudi Event Management has delivered projection mapping activations at AlUla's sandstone formations and heritage buildings, coordinating site access and zero-impact production protocols with the heritage authority." },
      ...
      { q: "event production company AlUla Saudi Arabia", a: "Saudi Event Management is an experienced AlUla event production partner, coordinating world-class productions for private concerts, brand activations, and heritage site events." },
    ],
    relatedServices: [
      { title: "Destination Events", slug: "destination-events" },
      { title: "Luxury & VIP Events", slug: "luxury-vip-events" },
  ...
  "vip-events-alula": {
    ...
    details: "Our AlUla luxury team manages the full heritage-site permitting process, ensuring your private event integrates seamlessly with the landscape while meeting all heritage conservation requirements.",
    bulletPoints: [
      ...
      "Full heritage-site-compliant zero-impact event production",
    ],
    faqs: [
      { q: "Can I host a private event at Maraya concert hall in AlUla?", a: "Yes. Saudi Event Management has experience securing private event access to the Maraya concert hall for invitation-only concerts, brand events, and ultra-luxury gatherings. We manage all heritage-site permitting and venue logistics." },
      ...
      { q: "VIP event planner near me AlUla", a: "Saudi Event Management is an experienced AlUla luxury event planning partner, with a dedicated local team and strong relationships across major venues, heritage sites, and resort properties in the region." },
    ],
    relatedServices: [
      { title: "Destination Events", slug: "destination-events" },
      { title: "Event Production", slug: "event-production" },
  ...
  "destination-events-alula": {
    ...
    details: "Saudi Event Management is an experienced destination event planning partner in AlUla, providing full logistics management, heritage-site permit facilitation, and production services for all event types in this unique environment.",
    bulletPoints: [
      ...
      "Full heritage-site permit processing and compliance management",
    ],
    faqs: [
      ...
      { q: "What logistics does AlUla destination event planning involve?", a: "AlUla destination events require charter flight or luxury road transfer arrangements, resort accommodation buyouts (Habitas AlUla, Banyan Tree), heritage-site access permits, remote production logistics, and dedicated on-the-ground management teams." },
      { q: "destination event planner AlUla Saudi Arabia", a: "Saudi Event Management is an experienced AlUla destination event planning company, with strong relationships across major venues, heritage sites, and resort properties in the region." },
    ],
    relatedServices: [
      { title: "Destination Events", slug: "destination-events" },
      { title: "Luxury & VIP Events", slug: "luxury-vip-events" },
  ...
  "destination-events-neom": {
    ...
    faqs: [
      ...
      { q: "destination event planner NEOM Saudi Arabia", a: "Saudi Event Management is an experienced destination event planner for NEOM, coordinating with the region's hospitality and events venues." },
    ],
    relatedServices: [
      { title: "Destination Events", slug: "destination-events" },
      { title: "Luxury & VIP Events", slug: "luxury-vip-events" },
...
> = {
  ...
  "event-production-alula": {
    ...
    faqs: [
      { q: "هل يمكنكم الإسقاط الضوئي في مواقع العلا التراثية؟", a: "نعم. نفّذت إدارة الفعاليات السعودية تفعيلات إسقاط ضوئي على تكوينات العلا الرملية ومبانيها التراثية، وننسّق وصول الموقع وبروتوكولات الإنتاج بأثر صفري مع هيئة التراث." },
  ...
  "vip-events-alula": {
    ...
    details: "يدير فريق الفخامة لدينا في العلا كامل عملية تصاريح المواقع التراثية، لضمان اندماج فعاليتك الخاصة بسلاسة مع المشهد مع استيفاء كل متطلبات حفظ التراث.",
    bulletPoints: [
    ...
    faqs: [
      { q: "هل يمكنني استضافة فعالية خاصة في قاعة مرايا بالعلا؟", a: "نعم. لدى إدارة الفعاليات السعودية خبرة في تأمين وصول الفعاليات الخاصة إلى قاعة مرايا للحفلات بالدعوة فقط، وفعاليات العلامات، والتجمّعات الفاخرة للغاية. ونحن ندير كل تصاريح المواقع التراثية ولوجستيات القاعة." },
  ...
  "destination-events-alula": {
    ...
    details: "إدارة الفعاليات السعودية هي شريك تخطيط فعاليات وجهة ذو خبرة في العلا، تقدّم إدارة لوجستيات متكاملة، وتسهيل تصاريح المواقع التراثية، وخدمات إنتاج لكل أنواع الفعاليات في هذه البيئة الفريدة.",
    bulletPoints: [
      ...
      "معالجة تصاريح المواقع التراثية وإدارة الامتثال بالكامل",
    ],
    faqs: [
      ...
      { q: "ما اللوجستيات التي يتضمّنها تخطيط فعاليات الوجهة في العلا؟", a: "تتطلّب فعاليات الوجهة في العلا ترتيبات رحلات مستأجرة أو نقل بري فاخر، واستحواذ إقامة المنتجعات (حبيتاس العلا، بانيان تري)، وتصاريح وصول المواقع التراثية، ولوجستيات إنتاج نائية، وفرق إدارة ميدانية مخصّصة." },
