      ...
      <div className="pt-32 pb-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-invert prose-gold max-w-none text-gray-300">
            ...
            <h2 className="text-2xl text-gold-500 mt-8 mb-4">Data Protection & Security</h2>
            <p className="mb-4">
            ...
            <h2 className="text-2xl text-gold-500 mt-8 mb-4">Cookies & Tracking Technologies</h2>
            <p className="mb-4">
            ...
            <h2 className="text-2xl text-gold-500 mt-8 mb-4">Third-Party Sharing</h2>
            <p className="mb-4">
            ...
            <h2 className="text-2xl text-gold-500 mt-8 mb-4">Data Retention</h2>
            <p className="mb-4">
            ...
            <h2 className="text-2xl text-gold-500 mt-8 mb-4">Your Rights</h2>
            <p className="mb-4">
