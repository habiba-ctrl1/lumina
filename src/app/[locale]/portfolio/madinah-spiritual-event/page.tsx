    ...
    <main className="min-h-screen bg-white overflow-hidden pt-20">
      ...
      <section className="relative h-[80vh] flex items-center justify-center">
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto pt-20">
          ...
          <h1 className="text-4xl md:text-6xl font-sans font-bold text-black mb-8 leading-tight uppercase tracking-tight">
            Madinah <span className="text-primary ">Spiritual</span> Event
          </h1>
      ...
      <section className="py-20 md:py-28 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-gray-600 font-light text-base leading-relaxed space-y-24">
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          <div className="relative aspect-square rounded-[3rem] overflow-hidden shadow-2xl border border-slate-200">
            <Image src="/gallery_charity_gala.webp" alt="Madinah Event Ambience" width={800} height={800} className="w-full h-full object-cover" />
          </div>
          <div>
            <h2 className="text-2xl md:text-3xl font-sans font-bold text-black mb-8 uppercase tracking-tight">The <span className="text-primary ">Essence</span></h2>
            <p className="mb-8">
        ...
        {/* Pillars of Peace */}
        <div>
          <h2 className="text-2xl md:text-3xl font-sans font-bold text-black mb-12 uppercase tracking-tight">Pillars of <span className="text-primary ">Peace</span></h2>
      ...
      <section className="py-16 bg-slate-50 border-t border-slate-200">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <Link href="/locations/makkah" className="px-5 py-2.5 bg-white border border-slate-200 rounded-full text-xs font-medium text-slate-700 hover:border-emerald-500 hover:text-emerald-700 transition-colors">
      ...
      <section className="py-32 text-center bg-white">
        <h2 className="text-2xl md:text-3xl font-sans font-bold text-black mb-8 uppercase tracking-tight">Host a <span className="text-primary ">Soulful Gathering</span></h2>
        <Link
          href="/contact"
