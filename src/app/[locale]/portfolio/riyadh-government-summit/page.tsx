...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return caseStudyMetadata("riyadh-government-summit", locale);
}
...
export default function RiyadhGovernmentSummit() {
  return (
    <main className="min-h-screen bg-white overflow-hidden pt-20">
      <Navbar />
      <CaseStudySchema slug="riyadh-government-summit" />

      {/* Hero */}
      <section className="relative h-[80vh] flex items-center justify-center">
        <div className="absolute inset-0 z-0 bg-cover bg-center md:bg-fixed" style={{ backgroundImage: "url('/riyadh_summit_people.webp')" }}>
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto pt-20">
          ...
          <h1 className="text-4xl md:text-6xl font-sans font-bold text-neutral-900 mb-8 leading-tight uppercase tracking-tight">
            Riyadh <span className="text-[var(--primary)]">Government Summit</span>
          </h1>
      ...
      <section className="py-20 md:py-28 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-neutral-600 font-light text-base leading-relaxed space-y-24">
        ...
        <div className="bg-neutral-900 text-white p-12 md:p-24 rounded-3xl text-center relative overflow-hidden">
          <div className="absolute inset-0 opacity-20">
            <Image src="/riyadh_summit_people.webp" alt="Summit" fill sizes="100vw" className="object-cover" />
          </div>
      ...
      <CaseStudyCTA slug="riyadh-government-summit" />
      <Footer />
      <WhatsAppButton />
    </main>
  );
