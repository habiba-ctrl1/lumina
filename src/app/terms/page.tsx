    ...
    <main className="min-h-screen bg-charcoal-900 overflow-hidden">
      ...
      <div className="pt-32 pb-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="text-3xl md:text-4xl font-sans font-bold text-white mb-6">Terms of Service</h1>
          <div className="prose prose-invert prose-gold max-w-none text-gray-300">
            ...
            <h2 className="text-2xl text-gold-500 mt-8 mb-4">Payment Terms</h2>
            <p className="mb-4">
            ...
            <h2 className="text-2xl text-gold-500 mt-8 mb-4">Cancellation & Rescheduling</h2>
            <p className="mb-4">
            ...
            <h2 className="text-2xl text-gold-500 mt-8 mb-4">Limitation of Liability</h2>
            <p className="mb-4">
            ...
            <h2 className="text-2xl text-gold-500 mt-8 mb-4">Force Majeure</h2>
            <p className="mb-4">
            ...
            <h2 className="text-2xl text-gold-500 mt-8 mb-4">Governing Law</h2>
            <p className="mb-4">
