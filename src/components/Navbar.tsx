...
const services = [
  ...
  { key: "birthdayParty",     href: "/services/birthday-party",    icon: Cake },
];
...
const aboutItems = [
  ...
  { label: "Partner With Us",    href: "/partner-onboarding",       icon: Handshake,  desc: "Join our vendor & partner network"    },
